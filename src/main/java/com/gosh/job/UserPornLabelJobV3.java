...
public class UserPornLabelJobV3 {
    ...
    // Redis Key 前缀和后缀
    private static final String REDIS_KEY_POS = "rec_post:{%d}:rtylevel_v3";               // key1: 正反馈最高等级（旧格式，业务使用）
    private static final String REDIS_KEY_NEG = "rec_post:{%d}:rtylevel_v3_only_for_degree"; // key2: 负反馈最低等级（旧格式，业务使用）
    private static final String REDIS_KEY_POS_META = "rec_post:{%d}:rtylevel_v3_meta";               // key1_meta: 正反馈元数据（新格式，包含时间戳）
    private static final String REDIS_KEY_NEG_META = "rec_post:{%d}:rtylevel_v3_only_for_degree_meta"; // key2_meta: 负反馈元数据（新格式，包含时间戳）
